...
/**
 * Renders a form for adding a second item with date, time, and image fields.
 *
    ...
    return(
            <div className="ml-10 mb-10">
                ...
                <div className="grid grid-cols-1">
                    ...
                    <input className="bg-sky-100 w-[90%] md:w-96 drop-shadow-xl xs:w-72" type="file" onchange="readURL(this)" />
                </div>
