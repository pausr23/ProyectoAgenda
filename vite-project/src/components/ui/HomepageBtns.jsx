...
export function HomepageBtns(){
    return(
        <div className="relative pl-8 lg:flex lg:flex-row lg:items-end lg:content-stretch flex flex-col lg:space-x-6 md:space-y-6 sm:space-y-6 xs:space-y-6 md:bottom-[25rem] sm:bottom-[20rem] xs:bottom-[15rem]">
            <Link to="/signup">
            ...
            <Link to="/login">
                <button className="bg-none border-white rounded-[10rem] border-4 px-14 py-2 mt-4">
