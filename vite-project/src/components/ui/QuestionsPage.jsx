        ...
        <div> 
            ...
            <div className="text-center mt-4 ml-10">
              ...
              <div className="grid grid-cols-2 text-left">
                ...
                <p className="text-2xl font-semibol">Michael Johnson</p>
              </div>

          <div className="grid grid-cols-2 mt-14 text-left">
            <p className="text-xl mt-2 text-gray-500 text-left">Email</p>
            <p className="text-2xl font-semibol">Michael@gmail.com</p>
          </div>

          <div className="grid grid-cols-2 mt-14 text-left">
            <p className="text-xl mt-2 text-gray-500">Height</p>
            <input className=" p-1 w-[100%] border-b border-[#928F8F]  font-semibold text-xl outline-none text-[#01244A] mx-auto" type="text" id="height" name="height" required placeholder="Height"/>
          </div>

          <div className="grid grid-cols-2 mt-14 text-left">
            <p className="text-xl mt-2 text-gray-500">Weight</p>
            <input className=" p-1 w-[100%] border-b border-[#928F8F]  font-semibold text-xl outline-none text-[#01244A] mx-auto" type="text" id="weight" name="weight" required placeholder="Weight"/>
          </div>

          <div className="grid grid-cols-2 mt-14 text-left">
            <p className="text-xl mt-2 text-gray-500">Sleep hours</p>
            <input className=" p-1 w-[100%] border-b border-[#928F8F] font-semibold text-xl outline-none text-[#01244A] mx-auto" type="text" id="hours" name="ehours" required placeholder="Hours"/>
          </div>

          <div className="grid grid-cols-2 mt-14 text-left">
            <p className="text-xl mt-2 text-gray-500">Health conditions</p>
            <input className=" p-1 w-[100%] border-b border-[#928F8F]  font-semibold text-xl outline-none text-[#01244A] mx-auto" type="text" id="condition" name="condition" required placeholder="Condition"/>
          </div>
              ...
              <div className="flex justify-center mt-10 ">
                <form action="" className="grid justify-items-center">
                  ...
                  <input
                    ...
                    name=""
                    id=""
                    className="py-3 p-5 rounded-md  bg-white md:w-[500px] w-[300px]"
